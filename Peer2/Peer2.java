...
public final class Peer2 implements Runnable
{
    ...
    public static void main(String[] args) throws InvalidAlgorithmParameterException, NoSuchAlgorithmException 
    {
        if (args.length != MINARG )
		{
			...
			System.out.println("java Peer2 <serverPort>");
			System.exit(1);
		}
        String port;
        port = args[0];
    ...
    public Peer2(String port) throws InvalidAlgorithmParameterException, NoSuchAlgorithmException
    {
        while(true)
        {
