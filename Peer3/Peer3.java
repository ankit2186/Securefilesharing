...
public final class Peer3 implements Runnable
{
    ...
    public static void main(String[] args) throws InvalidAlgorithmParameterException, NoSuchAlgorithmException 
    {
        if (args.length != MINARG )
		{
			...
			System.out.println("java Peer3 <serverPort>");
			System.exit(1);
		}
        String port;
        port = args[0];
    ...
    public Peer3(String port) throws InvalidAlgorithmParameterException, NoSuchAlgorithmException
    {
        while(true)
        {
